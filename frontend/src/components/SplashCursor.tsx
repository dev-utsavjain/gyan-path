...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    const { gl, ext }: any = getWebGLContext(canvas);
  ...
  }, [COLOR, RAINBOW_MODE, SIM_RESOLUTION, DYE_RESOLUTION, CAPTURE_RESOLUTION, DENSITY_DISSIPATION, VELOCITY_DISSIPATION, PRESSURE, PRESSURE_ITERATIONS, CURL, SPLAT_RADIUS, SPLAT_FORCE, SHADING, COLOR_UPDATE_SPEED, BACK_COLOR, TRANSPARENT]);
